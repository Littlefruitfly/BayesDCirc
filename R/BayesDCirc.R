##' Detecting differential circadian pattern using gibbs sampling
##'
##' We want to use gibbs sampling to sample from posterior distributions for our parameter
##' @title gibbs sampling main function
##' @param Y1 expression values of group 1. It needs unique row names.
##' @param Y2 expression values of group 2. It needs unique row names.
##' @param t1 phenotype data of group 1
##' @param t2 phenotype data of group 2
##' @param n.iter number of iteration. Default is 10000.
...
##' @export
##' 
BayesDCirc <- function(Y1, Y2, t1, t2, n.iter, hyperparameters, showIteration, priorInformation = NULL, priorFDR = NULL, Period = 24){
    ...
    names(output) <- c("p_I_post","p_L_post", "E1", "F1", "M1","mu_E", "mu_F", "mu_M", "E2", "F2","M2", "sig2_1_post", "sig2_2_post",
                       ...
                       "E1_record","F1_record","M1_record","E2_record","F2_record","M2_record", "gene_candidates")
